 ...
 *
 */
public class ProducersFuserIntersection extends
        AttributeValueFuser<List<Producer>, Movie, Attribute> {

    public ProducersFuserIntersection() {
        super(new Intersection<Producer, Movie, Attribute>());
    }
    ...
    @Override
    public List<Producer> getValue(Movie record, Correspondence<Attribute, Matchable> correspondence) {
        return record.getProducers();
    }
