 ...
 *
 */
public class ProducersFuserUnion extends AttributeValueFuser<List<Producer>, Movie, Attribute> {

    public ProducersFuserUnion() {
        super(new Union<Producer, Movie, Attribute>());
    }
