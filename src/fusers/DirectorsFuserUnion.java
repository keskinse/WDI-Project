 ...
 *
 */
public class DirectorsFuserUnion extends AttributeValueFuser<List<Director>, Movie, Attribute> {

    public DirectorsFuserUnion() {
        super(new Union<Director, Movie, Attribute>());
    }
